...
def tool():
  ...
  def options1():
    ...
    os.system('cls' if os.name=='nt' else 'clear')
    ctypes.windll.kernel32.SetConsoleTitleW("Raptor Multi Tool By Aran ")
    print(f'''
    {Fore.MAGENTA}                        	██████╗  █████╗ ██████╗ ████████╗ ██████╗ ██████╗ 
    {Fore.MAGENTA}                        	██╔══██╗██╔══██╗██╔══██╗╚══██╔══╝██╔═══██╗██╔══██╗
    {Fore.MAGENTA}                        	██████╔╝███████║██████╔╝   ██║   ██║   ██║██████╔╝
...
{Fore.RED} | |_| | | |_| | | | |_| | |_) |
  ...
  [\>]""")
    ...
    if gh in ['01','1']:
      webbrowser.open('https://github.com/zurich869')
    elif gh in ['02','2']:
      webbrowser.open('')
    else:
...
{Fore.RED} | |__| (_) | (_| | | | | |
 ...
 \033[31m| |___| | |  __/ (_| | | |_\__ \ 
  \____|_|  \___|\__,_|_|\__|___/
    ...
    ''')
    By = Fore.LIGHTBLACK_EX + 'Raptor was made by  | Helper al1ce0_'
    Aran = Fore.MAGENTA + 'Whynotshort.'
    Tkn = Fore.RED + 'al1ce0_'
    Vivid = Fore.CYAN + 'z_zebran'
...
{Fore.RED} | |_| | \__ \ (_| (_) | | | (_| | 
 |____/|_|___/\___\___/|_|  \__,_| 
  ...
  [2] al1ce0_ Discord (Webass)

  [?>]'''))


    if whichserver == 1:
      webbrowser.open('https://discord.gg/N8E7fjwf')
    elif whichserver == 2:
      webbrowser.open('https://discord.gg/pnhBJfHR')
    else:
      print("Invalid Option.")
...
{Fore.RED}   | | (_) | |_| || || |_| | |_) |  __/ 
   |_|\___/ \__,_||_| \__,_|_.__/ \___| 
    ...
    ''')
    webbrowser.open('https://www.youtube.com/channel/UCZsr-SUdWcRqANkiqXjoO5Q')
